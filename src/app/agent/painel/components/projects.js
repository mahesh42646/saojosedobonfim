...
const ProjectCard = ({ project }) => {
    ...
    return (
        ...
        style={{ border: '0.01px solid rgb(255, 255, 255)'}}>
            <Image
                src={!imgError && project.coverPhoto ? `http://localhost:4000/uploads/${project.coverPhoto}` : '/images/card.png'}
                alt={project.title}
                width={70}
                height={70}
    ...
    return (
        <Container className="pt-4">
            ...
            <div className="d-flex align-items-center p-2 rounded-4" style={{ border: '1px solid #e0e0e0', backgroundColor: '#fff' }}>
                <Image
                    src={project.coverPhoto ? `http://localhost:4000/uploads/${project.coverPhoto}` : '/images/card.png'}
                    alt={project.title}
                    width={70}
                    height={70}
